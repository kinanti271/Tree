...
public class 09_AyudyaKarinaKinanti {
    ...
    private static void addPatient() {
        ...
        int age = getValidIntInput("Masukkan usia pasien: ");
        String condition = getValidStringInput("Masukkan deskripsi kondisi: ");
        int priority = getValidIntInRange("Masukkan prioritas (1-Critical to 5-Non-urgent): ", 1, 5);
